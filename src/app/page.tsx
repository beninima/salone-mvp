  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="px-4 py-6 grid grid-cols-2 gap-4">
        <Link href="/clienti" className="bg-white rounded-lg shadow p-4 hover:shadow-md transition-shadow">
          <div className="text-3xl font-bold text-blue-600">{data.totalClienti}</div>
          <div className="text-sm text-gray-600 mt-1">Clienti Totali</div>
        </Link>

        <Link href="/appuntamenti" className="bg-white rounded-lg shadow p-4 hover:shadow-md transition-shadow">
          <div className="text-3xl font-bold text-green-600">{data.appuntamentiOggi}</div>
          <div className="text-sm text-gray-600 mt-1">Oggi</div>
        </Link>
      </div>
      ...
      <div className="px-4 py-2">
        <div className="flex justify-between items-center mb-3">
          ...
          <Link href="/appuntamenti" className="text-blue-600 text-sm font-medium">
            Vedi tutti →
          </Link>
        </div>
                ...
                <div key={app.id} className="bg-white rounded-lg shadow p-4">
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">{app.servizio}</p>
      ...
      <div className="px-4 py-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-3">Azioni Rapide</h2>
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div className="text-sm font-medium text-gray-900">Nuovo Intervento</div>
          </Link>
          <Link
            href="/prodotti"
            className="bg-white rounded-lg shadow p-4 text-center hover:shadow-md transition-shadow"
