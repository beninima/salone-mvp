      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
          ...
          <textarea
            ...
            className="w-full p-4 pr-12 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
          />
          <Scissors className="absolute right-4 top-14 w-5 h-5 text-gray-400 hover:text-blue-500 transition-colors" />
        </div>
